...
function App() {
  ...
  return <main>
    ...
    <section className="hero" id="top">
      <motion.div className="hero-copy" {...fadeUp}><p className="eyebrow"><span className="eyebrow-rule" /><span>HELLO, I&apos;M</span></p><h1>SYLVIA<span className="period">.</span></h1><p className="hero-line">{site.hero.tagline}</p><p className="hero-intro">{site.hero.intro}</p><div className="hero-actions"><a className="button button-dark" href="#projects">查看项目 <ArrowDown size={16} /></a><a className="button button-light" href={`mailto:${site.links.email}`}>联系我 <Mail size={16} /></a></div></motion.div>
